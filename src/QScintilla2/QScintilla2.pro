...
TRANSLATIONS += qscintilla_cs.ts
TRANSLATIONS += qscintilla_de.ts
TRANSLATIONS += qscintilla_es.ts
TRANSLATIONS += qscintilla_fr.ts
TRANSLATIONS += qscintilla_pt_br.ts
